...
class Resource(models.Model):
    resource = models.CharField(max_length=200, default="", blank=True,
                                null=True)
...
class Video(models.Model):
    ...
    author = models.CharField(max_length=100, default="", blank=True,
                              null=True)
    copyrightholder = models.CharField(max_length=300, default="",
    ...
    image_url = models.URLField(
        default='http://www.columbia.edu/itc/tc/cstudies/imagesequence/',
        blank=True, null=True)
    real_video_url = models.URLField(
        default=('http://kola.cc.columbia.edu:8080/ramgen/itcmedia/'
                 'tc/culturalstudies/'),
        blank=True, null=True)
    sequence_url = models.URLField(
        default='http://www.columbia.edu/itc/tc/cstudies/imagesequence/',
        blank=True, null=True)
    local_video = models.BooleanField(default=False)
    real_video_filename = models.CharField(max_length=200, default="",
                                           blank=True, null=True)
    local_image = models.BooleanField(default=False)
    image_filename = models.CharField(max_length=200, default="",
                                      blank=True, null=True)
    sequence_prefix = models.CharField(max_length=200, default="",
                                       blank=True, null=True)
