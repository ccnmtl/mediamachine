...
urlpatterns = patterns('',
                       ...
                       ('^$','mediamachine.machine.views.limited_direct_to_template', {'template' : 'machine/index.html'}),
                       ...
                       url('^video/(?P<object_id>\d+)/$','mediamachine.machine.views.limited_object_detail',
                       ...
                       url('^theme/(?P<object_id>\d+)/$','mediamachine.machine.views.limited_object_detail',
                       ...
                       url('^keyword/(?P<object_id>\d+)/$','mediamachine.machine.views.limited_object_detail',
